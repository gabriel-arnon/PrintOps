      ...
      <CardContent className="h-72 px-1 pb-3 pt-0">
        {data.length === 0 ? (
          <ChartEmptyState
            ...
            hint="Adicione impressoras ou aguarde a primeira varredura para visualizar o consumo por dispositivo."
          />
        ) : (
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                ...
                formatter={(value: number) => [`${value}%`, "Nível de toner"]}
              ...
              >
                {data.map((entry, i) => (
                  <Cell key={i} fill={barFillForPercent(entry.toner)} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
